...
int seg = 0, _seg = 0, __seg = 0;
int minutos = 0, _minutos = 0, __minutos = 0;
int hora = 0, _hora = 0, __hora = 0;
...
// void ConfigurarTiempos(uint8_t temp)
...
void VerificarBtnEmergencia()
{
    if (digitalRead(btnEmergencia) == EstadoEmergencia)
    {
        ...
        noInterrupts();
        digitalWrite(outEmergencia, EstadoEmergencia); //activa pin de emergencia
        digitalWrite(outTiempo, !EstadoEmergencia);    //desactiva pin de tiempo
        digitalWrite(outFinalTiempo, !EstadoEmergencia);
        hora = _hora;
        minutos = _minutos;
        seg = _seg;
        limite = 0;
        ...
        Emergencia = false;
        digitalWrite(outEmergencia, !EstadoEmergencia);
        ReiniciarTiempoBackLight();
        ConfigurarTiempos();
        ImprimirEstado();
    }
